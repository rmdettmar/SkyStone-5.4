...
@TeleOp(name="Drive Avoid Imu 2", group="Exercises")
//@Disabled
public class DriveAvoidIMU2 extends LinearOpMode
{
...
//        touch = hardwareMap.touchSensor.get("touch_sensor");
        ...
        while (opModeIsActive())
        {
            ...
            while (isStraight == true && opModeIsActive()) {
                ...
                leftMotor.setPower(maxMotorPower(.35, _power - correction));
                rightMotor.setPower(maxMotorPower(.35, _power + correction));
                ...
                telemetry.addData("5 left motor power", maxMotorPower(.35, _power - correction));
                telemetry.addData("6 right motor power", maxMotorPower(.35, _power + correction));
                telemetry.update();
            }

            targetAngle += 90;
            targetAngle %= 360;
            rotate(90, .27, targetAngle);
            isStraight = true;
